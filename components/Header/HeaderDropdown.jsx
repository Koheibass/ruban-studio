        ...
        < ul className="flex pl-0">
            {
                ...
                <li className="p-0 m-0" id="dropdown">
                    <ul className="block w-full py-[2px] px-[7px] mt-[2px] mx-[1px] mb-0 text-[8px] font-thin pb-1 bg-[#FFF] border-solid border border-[#a07c43] rounded0px] text-[#a07c43] no-underline text-center lg:text-[20px] lg:py-[5px] lg:px-3 hover:bg-[#ebebeb] hover:text-[#fefaff]">予約はこちら</ul>
