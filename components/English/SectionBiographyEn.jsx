                    ...
                    <div className="max-w-none" id="profile">
...

                        {
                            ...
                            <p className='text-[#937a43]'>
                                Rina Akaboshi is a classical concert pianist. Although her forte is German music,
                                <br /> her recent focus has been on broadening her repertoire with French and Russian music.
                                <br /> She has a reputation for pursuing a mature expression and deep musicality,
                                <br />while exploring techniques in-depth to discover the ideal touch to bring out new possibilities in every tone.
                                <br />After receiving numerous awards in both national and international competitions,
                                <br />in 2018, her first solo album, “Neue Welt - New World” was released.
                                <br />Her concert activities continue while studying under Mr. Yuya Tsuda,
                                <br /> one of the most appreciated pianists in Japan, at Tokyo Art University (Graduate-level special course).
                                <br /><br />
                            </p>
                        }
                    </div>
