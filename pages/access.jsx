            ...
            <main className="grow bg-[#ffffff] px-4 lg:px-20" id="access">
                <div className='pt-8'>
                    <div className='pb-8'>
                        ...
                        <p className='text-[15px] pl-6 pb-2 pt-2'>（近隣にコインパーキングあり）</p>
                    </div>
