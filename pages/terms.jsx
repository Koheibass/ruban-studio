        ...
        <div className="flex flex-col relative min-h-lvh font-noto">
            ...
            <main className="grow bg-[#ffffff] px-4 lg:px-20 text-center">
                <div>
                    ...
                    <h4 className='pb-2 font-bold'>販売業者</h4>
                    <p className='pb-2'>ピアノスタジオ リュバン</p>
                    <h4 className='pb-2 font-bold'>販売責任者</h4>
                    ...
                    <h4 className='pb-2 font-bold'>販売価格</h4>
                    <p className='pb-2'>販売価格は、<br />表示された金額（消費税込）と致します。</p>
