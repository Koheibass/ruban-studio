            ...
            <main className="grow bg-[#ffffff] px-4 lg:px-20">
                <div className='pt-8 mx-6'>
                    ...
                    <div className='pt-6'>
                        ...
                        <h4 className='text-center'>入室方法動画</h4>
                        ...
                        <p>
                            ...
                            <br />
                            4. 外側扉の鍵を閉める<br />
                            5. マットの上で靴を脱ぎ、シューズラックに置き、スリッパに履き替える<br />
                    ...
                    <div>
                        ...
                        <p className='pt-4 text-[11px] leading-[22px] pb-4'>
                            ・ロックのかけ方など退室方法詳細はスタジオの扉面に記載していますので当日ご確認ください<br />
                            ・次の方のご予約時間が毎時00分から始まります 入れ替え時間もありますので必ず終了時間の5分前にはご退出いただくようご協力お願いいたします
                        </p>
